                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" name="payment_for" id="payment_for" required>
                                            <option value="">ជ្រើសរើសប្រភេទថ្លៃ</option>
                                            <option value="Tuition Fee" <?php echo ($payment['payment_for'] == 'Tuition Fee') ? 'selected' : ''; ?>>ថ្លៃសិក្សា</option>
                                            <option value="Registration Fee" <?php echo ($payment['payment_for'] == 'Registration Fee') ? 'selected' : ''; ?>>ថ្លៃចុះឈ្មោះ</option>
                                            <option value="Other Fee" <?php echo ($payment['payment_for'] == 'Other Fee') ? 'selected' : ''; ?>>ថ្លៃផ្សេងៗ</option>
                                        </select>
                                    </div>
